...
def renderizaMandelbrotBonito(x1, y1, x2, y2, ancho, iteraciones, nombreFicheroPNG, paleta, nColoresPaleta):
        ...
        image.save("./imagenes/"+nombreFicheroPNG, "PNG")


#renderizaMandelbrotBonito(-1,-1,1,1,300,100,"ey.png",[(100,100,100),(200,10,150),(199,366,400)],3)
#renderizaMandelbrot(-1,-1,1,1,300,100,"nombre2.png")
